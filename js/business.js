...
(function () {
    ...
    function initHeroGraph() {
        ...
        // Optimization: Cache gradient to avoid re-creation in every frame
        let cachedGradient;
        ...
        // Optimization: Refactored to eliminate array allocations and use textContent
        function drawGraph(progress) {
            ...
            if (valueSpan) {
                ...
                // Optimization: textContent is faster than innerText (avoids forced reflow)
