...
(function () {
    ...
    function initHeroGraph() {
        ...
        // Optimization: Cache gradient and value element to minimize per-frame allocations & lookups
        ...
        window.addEventListener('resize', () => {
            ...
            cachedGradient = null; // Invalidate cache on resize
            drawGraph(1);
        });
        ...
        function drawGraph(progress) {
            ...
            // Optimization: Direct loop over points avoids .slice().map() garbage collection pressure
            ...
            if (valueSpan) {
                ...
                // Optimization: textContent is faster than innerText as it avoids forced reflows
