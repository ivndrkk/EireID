...
(function () {
    ...
    function initHeroGraph() {
        ...
        // Optimization: Cache gradient and value DOM element outside the loop.
        // Also use textContent instead of innerText to avoid reflows.
        let gradient;
        ...
        function drawGraph(progress) {
            ...
            // Optimization: Avoid .slice().map() which causes garbage collection pressure
            // Iterate directly over the points array.
