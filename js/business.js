...
(function () {
    ...
    function initHeroGraph() {
        ...
        // Bolt Optimization: Cache DOM element and gradients outside animation loop.
        // Caching valueSpan prevents expensive DOM lookups on every frame (~60 lookups/sec).
        ...
        window.addEventListener('resize', () => {
            ...
            // Re-create gradient on resize since height changes
        ...
        function drawGraph(progress) {
            ...
            // Bolt Optimization: Eliminate high-frequency array allocations.
            // Replacing .slice().map() with a direct for loop reduces garbage collection overhead.
            ...
            if (valueSpan) {
                ...
                // Bolt Optimization: Replace innerText with textContent.
                // textContent is not CSS-aware and avoids forced synchronous layouts (reflows).
