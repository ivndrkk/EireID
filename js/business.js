...
(function () {
    ...
    function initHeroGraph() {
        ...
        let cachedValueSpan = document.getElementById('hero-graph-value');
        ...
        function drawGraph(progress) {
            ...
            // Optimized: Iterating directly over points to avoid slice().map() allocations
            ...
            if (cachedValueSpan) {
                ...
                // Optimized: textContent is slightly faster than innerText and avoids forced reflow
